...
- #### Optimizer : 
   - ###### RMSprop
- #### Epsilon greedy : 
   - ###### ε decrease linearly from 1(ε<sub>min</sub>) to 0.0001(ε<sub>max</sub>) with step 0.0001(∆ε). In other word, after 100000 step, the ε wil be 0.001 for end of the training.
# Result 
